...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        # try:
        #     query        = OtpModel.objects.filter(otp_email__iexact = user_email)[]
        # except:
        #     raise Http404
        ...
        # print(user_email,model_email,user_otp,model_otp)
        # if user_email == model_email and user_otp == model_otp: 
        # print(user_email==model_email  and user_otp == model_otp)#and (current_time - otp_creation_time < 70):
        # print(coming_data)
